    ...
    return (
      <div>
        ...
        <p>
          ...
          https://infsci-2620-final.herokuapp.com/ website (the "Service")
          operated by HealthShare ("us", "we", or "our").
        </p>
        ...
        <p>
          ...
          access the Service. The Terms and Conditions agreement for HealthShare
          is based on the{" "}
        ...
        <p>
          ...
          that are not owned or controlled by HealthShare.
        </p>

        <p>
          HealthShare has no control over, and assumes no responsibility for,
          the content, privacy policies, or practices of any third party web
          sites or services. You further acknowledge and agree that HealthShare
